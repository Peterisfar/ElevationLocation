...
def icp(A, B, max_iterations=20, tolerance=0.001, init_pose=None, index = False):
    '''
    ...
    neigh = NearestNeighbors(n_neighbors=1,leaf_size=2)
    neigh.fit(dst[:m,:].T)
    ...
    if index:
        return r, t, np.mean(distances),indices
    else:
